...
export const metadata = buildPageMetadata({
  title: 'Sign In',
  description:
    'Sign in to SolarScout Pro to generate and manage commercial solar leads across Romania, Spain, Portugal, Albania and the United Kingdom.',
  path: '/login',
  keywords: ['sign in solar leads', 'SolarScout login', 'solar lead generation login'],
  noIndex: true,
})
