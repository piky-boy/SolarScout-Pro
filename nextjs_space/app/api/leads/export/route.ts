...
const EXPORT_COLUMNS: { key: string; label: string }[] = [
  ...
  { key: 'solarEnriched', label: 'Google Verified' },
  { key: 'solarRoofAreaSqm', label: 'Google Roof Area (m²)' },
  { key: 'buildingHeightM', label: 'Building Height (m)' },
  { key: 'roofPitchDeg', label: 'Roof Pitch (°)' },
  { key: 'roofAzimuthDeg', label: 'Roof Azimuth (°)' },
  { key: 'solarMaxPanelCount', label: 'Max Panels' },
  { key: 'solarYearlyEnergyKwh', label: 'Annual Energy (kWh)' },
  { key: 'solarType', label: 'Solar Type' },
